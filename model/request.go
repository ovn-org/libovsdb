...
// Types returns the DatabaseModelRequest Types
// the DatabaseModelRequest types is a map of reflect.Types indexed by string
...
func (db DatabaseModelRequest) Types() map[string]reflect.Type {
	return db.types
}
...
func (db DatabaseModelRequest) FindTable(mType reflect.Type) string {
